...
class ScheduleTwo extends Component {
  ...
  componentWillMount() {
    ...
    const SunFour = [];
    const SunFive = [];
    axios.get("/get_scheduled_officers_two").then((response) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <h1 className="day">Monday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Teusday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Wednesday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Thursday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Friday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Saturday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Sunday Schedule : (6.00 a.m - 12.00 p.m)</h1>
            <br />
          </div>
        </div>
