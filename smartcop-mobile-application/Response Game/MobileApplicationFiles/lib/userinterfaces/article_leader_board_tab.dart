...
class ArticleLeaderBoardPage extends StatefulWidget {
  @override
  _ArticleLeaderBoardPageState createState() => _ArticleLeaderBoardPageState();
}

class _ArticleLeaderBoardPageState extends State<ArticleLeaderBoardPage> {
  ...
  void fetchData() async{
    ...
    await Firestore.instance.collection("ScoreDetail").where("questionType",isEqualTo: "article").getDocuments().then((QuerySnapshot snapshot) {
