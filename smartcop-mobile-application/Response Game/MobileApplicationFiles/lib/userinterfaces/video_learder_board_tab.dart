...
class VideoLeaderBoardPage extends StatefulWidget {
  @override
  _VideoLeaderBoardPageState createState() => _VideoLeaderBoardPageState();
}

class _VideoLeaderBoardPageState extends State<VideoLeaderBoardPage> {
  ...
  void fetchData() async{
    ...
    await Firestore.instance.collection("ScoreDetail").where("questionType",isEqualTo: "video").getDocuments().then((QuerySnapshot snapshot) {
