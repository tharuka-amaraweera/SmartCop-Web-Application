...
import 'safe_life_quiz_welcome_screen.dart';
import 'leader_board_screen.dart';

 class OptionScreen extends StatefulWidget {
  OptionScreenState createState() {return OptionScreenState();
  }
 }
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          height: 200.0,
                          child: RaisedButton(
                              child: Text("Prevention Game",style: TextStyle(fontSize: 20.0,fontFamily: "Alike"),textAlign: TextAlign.center,),
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('images/smartcop_cover.jpg'),
            fit: BoxFit.cover
        ) ,
      ),
      child: Padding(
