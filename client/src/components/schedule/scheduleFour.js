...
class ScheduleFour extends Component {
  constructor() {
    super();
    this.state = {
      officer: [],
  ...
  componentWillMount() {
    ...
    const SunFour = [];
    const SunFive = [];
    axios.get("/get_scheduled_officers_four").then((response) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <h1 className="day">Monday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Teusday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Wednesday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Thursday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Friday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Saturday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Sunday Schedule : (6.00 p.m - 12.00 a.m)</h1>
            <br />
          </div>
        </div>
