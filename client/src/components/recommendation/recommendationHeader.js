    ...
    <nav className=" navbar-dark nav-bg" id="bgc">
      <div className="row">
        <div className="col-lg-3">
          <ul className="navbar-nav mr-auto">
            <li class="nav-item active bdr">
              <Link className="nav-link" to={"/timeZone_one"}>
                <font className="lnk">Time Zone 01</font> <br />
                <br />
        ...
        <div className="col-lg-3">
          <ul className="navbar-nav mr-auto">
            <li class="dropdown bdr">
              <Link className="nav-link" to={"/timeZone_two"}>
                <font className="lnk">Time Zone 02</font> <br />
                <br />
        ...
        <div className="col-lg-3">
          <ul className="navbar-nav mr-auto">
            <li class="nav-item active bdr">
              <Link className="nav-link" to={"/timeZone_three"}>
                <font className="lnk">Time Zone 03</font> <br />
                <br />
        ...
        <div className="col-lg-3">
          <ul className="navbar-nav mr-auto">
            <li class="nav-item active bdrcorner">
              <Link className="nav-link" to={"/timeZone_four"}>
