...
class ScheduleOne extends Component {
  constructor() {
    super();
    this.state = {
      officer: [],
  ...
  componentWillMount() {
    ...
    const SunFour = [];
    const SunFive = [];
    axios.get("/get_scheduled_officers_one").then((response) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <h1 className="day">Monday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        <div className="row">
            ...
            <div class="card" id="tbl">
              <table class="table table-striped table-hover ">
                ...
                <tbody>
                  <tr>
                    <td className="tbdata">
                      <a className="tbdata" href="http://localhost:3000/tryParent" >
                      {Mon_one[0]}
                      </a>
                      <br />
                      {Mon_one[1]}
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Teusday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Wednesday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Thursday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Friday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Saturday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <br />
            <br />
            <h1 className="day">Sunday Schedule : (12.00 a.m - 6.00 a.m)</h1>
            <br />
          </div>
        </div>
