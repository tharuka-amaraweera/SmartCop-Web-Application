...
num_of_records=len(accident_df_for_ap)
print(num_of_records)

#label encoding
lbl_enc = LabelEncoder()
tf_acc_data = accident_df_for_ap.copy()
for i in accident_df_for_ap.columns:
    tf_acc_data[i]=lbl_enc.fit_transform(accident_df_for_ap[i])
...
area_count_df.to_json (r'./json_data/area_count_json.json',orient='columns')